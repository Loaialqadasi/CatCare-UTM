...
import { PasswordResetToken } from './password-reset.types.js';
...
export const passwordResetRepository = {
  ...
  // only valid tokens count (not expired, not already used)
  ...
  // invalidate everything when a user resets their password
