...
-- some sample pending donations so you can test the admin dashboard straight away
INSERT INTO donations (donor_name, donor_email, claimed_amount, receipt_url, status) VALUES
  ('Ahmad Faris', 'ahmad.faris@graduate.utm.my', 50.00, '/uploads/receipts/sample-receipt-1.jpg', 'pending'),
  ('Nurul Ain', 'nurul.ain@utm.my', 120.00, '/uploads/receipts/sample-receipt-2.jpg', 'pending'),
  ('Lee Chong Wei', 'lee.cw@graduate.utm.my', 200.00, '/uploads/receipts/sample-receipt-3.jpg', 'pending');
