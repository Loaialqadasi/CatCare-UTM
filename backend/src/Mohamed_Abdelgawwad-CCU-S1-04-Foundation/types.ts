...
export interface CareHistoryEntry {
  ...
  photoUrl: string | null;  // FIX: Added photo support for care history
  createdAt: string;
}
...
// FIX: New form data type for recording care history
...
// FIX: New form data type for submitting emergency proof with image
