...
-- ─── Donations ───
-- tracks every bank transfer submission from donors
-- status starts as 'pending' and moves to 'verified' or 'rejected' once an admin reviews it
...
-- quickly fetch the admin queue without scanning the whole table
