...
export function MyDonations() {
  ...
  const { setCurrentView, navigateToDonationDetail } = useAppStore();
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="flex items-center justify-between">
        ...
        <Button onClick={() => setCurrentView('create-donation')} className="bg-amber-500 hover:bg-amber-600 text-white">
      ...
      {donations.length === 0 ? (
        <Card className="rounded-xl border-border/50">
          <CardContent className="py-16 text-center">
            ...
            <Button onClick={() => setCurrentView('create-donation')} className="mt-6 bg-amber-500 hover:bg-amber-600 text-white">
          ...
          {donations.map((donation) => {
            ...
            return (
              <Card
                ...
                onClick={() => navigateToDonationDetail(donation.id)}
              >
