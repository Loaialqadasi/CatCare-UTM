...
function getViewTitle(view: string): string {
  const titles: Record<string, string> = {
    ...
    'donation-upload': 'Upload Donation Receipt',
    'donation-review': 'Donation Review',
    cats: 'Campus Cats',
...
function getViewDescription(view: string): string {
  const descriptions: Record<string, string> = {
    ...
    'donation-progress': 'Real-time fundraising progress for UTM cats',
    'donation-upload': 'Submit payment proof for donation verification',
    'donation-review': 'Approve or reject donation submissions',
