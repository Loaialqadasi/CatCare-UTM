...
export function Header({ onMenuClick }: HeaderProps) {
  const { user, logout: storeLogout, setCurrentView } = useAppStore();
...
function getViewTitle(view: string): string {
  const titles: Record<string, string> = {
    ...
    'donation-detail': 'Donation Details',
    'create-donation': 'Make a Donation',
    'admin-donations': 'Review Donations',
    profile: 'My Profile',
  };
  return titles[view] || 'CatCare UTM';
}
...
function getViewDescription(view: string): string {
  const descriptions: Record<string, string> = {
    ...
    'donation-detail': 'Donation details and status',
    'create-donation': 'Contribute to campus cat care',
    'admin-donations': 'Review and manage donation submissions',
