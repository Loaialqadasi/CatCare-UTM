...
import { Users, ClipboardCheck, AlertTriangle, Cat, ArrowRight, HandHeart } from 'lucide-react';
import { cn } from '@/lib/utils';
import { fetchDonationSummary, fetchCats, fetchEmergencies } from '@/lib/api-client';
...
export default function AdminPage() {
  ...
  useEffect(() => {
    ...
    async function loadStats() {
      try {
        const [donationSummary, catsRes, emergenciesRes] = await Promise.allSettled([
