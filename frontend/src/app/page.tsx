...
import { DonationProgressTracker } from '@/components/dashboard/donation-progress-tracker';
...
import { DonationReview } from '@/components/donations/donation-review';
...
function AppRouter({ view }: { view: AppView }) {
  switch (view) {
    ...
    case 'donation-progress':
      return <DonationProgressTracker />;
    case 'donation-upload':
      return <CreateDonationForm />;
    case 'donation-review':
