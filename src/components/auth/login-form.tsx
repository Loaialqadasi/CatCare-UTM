...
export function LoginForm() {
  const [email, setEmail] = useState('ahmed@utm.my');
          ...
          <CardContent>
            ...
            <div className="mt-4 p-3 rounded-lg bg-amber-50 border border-amber-200">
              <p className="text-xs text-amber-700 text-center">
                <span className="font-semibold">Demo Mode:</span> Use any email/password to login, or click Sign In with pre-filled credentials.
              </p>
            </div>
          </CardContent>
        </Card>
