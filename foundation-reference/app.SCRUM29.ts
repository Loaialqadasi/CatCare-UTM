...
import { donationsRoutes } from '../Mohamed_Abdelgawwad-CCU-S1-05-Donations/donations.routes.js';
...
app.use('/uploads/cats', express.static(path.join(process.cwd(), 'uploads', 'cats')));
